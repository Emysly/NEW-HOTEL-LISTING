...
function () {
  ...
  _createClass(HotelController, null, [{
    key: "getAllHotels",
    value: function () {
      var _getAllHotels = _asyncToGenerator(
      /*#__PURE__*/
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                res.sendFile("".concat(_appRootPath["default"], "/public/hotel.html"));
      ...
      function getAllHotels(_x, _x2) {
        return _getAllHotels.apply(this, arguments);
      }
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee2(req, res) {
        var id, created_by, _req$body, name, website, city, state, rating, price, hotels, users, newHotel;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 8:
                ...
                created_by = users.find(function (user) {
                  return user.id === id;
